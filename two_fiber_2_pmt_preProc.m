...
%Josh Pace 20211007 changed axis labeling and other ploting aspects 
%Josh's Computer Version ('uigetdir' path)
...
%dataDir = uigetdir("/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/Josh/DiFC Data/NIR/OTL38 Mice/OTL38 L1210A 20220126");
% dataDir = uigetdir("/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/Josh/DiFC Data/NIR/OTL38 Mice/OTL38 L1210A 20220202");
% dataDir = uigetdir("/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/Josh/DiFC Data/NIR/OTL38 Phantom/Ultra Fiber Probe/SK-OV-3 20220302/");
if phantom
%     dataDir = uigetdir("/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/Josh/DiFC Data/NIR/OTL38 Phantom/Ultra Fiber Probe/");
    dataDir = uigetdir("/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/Josh/DiFC Data/NIR/OTL38 Phantom/Ultra Fiber Probe/Unlabeled Cells 20220417");
else
    dataDir = uigetdir("/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/Josh/DiFC Data/NIR/OTL38 Mice");
    %dataDir = uigetdir("/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/Josh/Papers and Conferences/NIR 1/Data/Mice/BG Control Data-Jessica RT Studies/Updated Data/Cohort 1");
end
if dataDir == 0
    fprintf('\nProcessing canceled\n\n')
    return
...
%***************************************************
% proccodes_library ="/Users/joshpace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/DiFC Files/codes/proccodes";

proccodes_library ="/Users/jspace/Library/CloudStorage/OneDrive-SharedLibraries-NortheasternUniversity/Niedre, Mark - Niedre_Lab/DiFC Files/codes/proccodes";
...
fprintf('Running 2 Probe 2 PMTs preProc for %s...\n\n',stem)
if ~noProc
...
% %     %Messing around with filtering the PPG signal from OTL38 injected mice
    notchSpecs2  = fdesign.notch('N,F0,Q,Ap',2, 0.00657,20,1);
    notchFilt2 = design(notchSpecs2,'SystemObject',true);

% % fvtool(notchFilt2)
% 
% data = notchFilt2(data);
% filteredData = 1;
% %Cutting out first 10 seconds because of the filter behavior around 0
% filterData_1 = data(20001:end,1);
% filterData_2 = data(20001:end,2);
% clear data
% data = [filterData_1 filterData_2];
% filterTime = time(20001:end);
% time = filterTime-10;
...
%                 ylabel('Count','FontSize',15);
        ...
        try
            ...
            ylabel(tl,'Count','FontSize',18,'FontWeight','bold');
            saveas(figure(7),[figFolder slash 'Fwd MatchedPeak Candidate SNR Histogram.fig']); 
        catch
           fprintf("No Fwd Matched SNR Histogram displayed\n");
           saveas(figure(7),[figFolder slash 'Fwd Peak Candidate SNR Histogram.fig']); 
        end
